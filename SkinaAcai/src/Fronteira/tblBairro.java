...
public class tblBairro extends javax.swing.JPanel {
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        bairros.setNome(txtBairro.getText());
        bairros.setPreco(Double.parseDouble(txtTaxa.getText()));
        //bairros.setCod(txtCamCorALT.getText());   TESTAR DEPOIS NO BANCO     

        PerBairros pa = new PerBairros();
        pa.AlterarBairros(bairros);
    ...
    private void jTable1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyPressed
        ...
        txtBairro.setText(jTable1.getValueAt(jTable1.getSelectedRow(), 2) + "");
        txtTaxa.setText(jTable1.getValueAt(jTable1.getSelectedRow(), 3) + "");
