...
public class TlAlterarGastos extends javax.swing.JFrame {

    TlGastos testeP;

    public TlAlterarGastos() {
        initComponents();
    }

    public TlAlterarGastos(TlGastos teste) {
        initComponents();
        testeP = teste;
    }
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        ...
        if (txtNome.getText().isEmpty() || txtNome.getText().length() > 60) {
            JOptionPane.showMessageDialog(null, "Preencha o campo gasto corretamente!");
            txtNome.setText("");
            ...
            ClsGastos altGastos = new ClsGastos();

            altGastos.setNome(txtNome.getText());
            altGastos.setPreco(Double.parseDouble(txtValor.getText()));
            altGastos.setCod(Integer.parseInt(lbCod.getText()));

            PerGastos gastos = new PerGastos();
            gastos.AlterarGastos(altGastos);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TlAlterarGastos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TlAlterarGastos().setVisible(true);
            }
        });
    }
